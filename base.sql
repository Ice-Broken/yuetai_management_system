...
-- ----------------------------
-- Table structure for prod_requirement
-- ----------------------------
DROP TABLE IF EXISTS `prod_requirement`;
CREATE TABLE `requirement` (
  ...
  `company_name_ch` varchar(200) DEFAULT NULL,
  `company_name_en` varchar(200) DEFAULT NULL,
  `contact_name` varchar(50) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `prodcts` varchar(100) DEFAULT NULL,
