<template>
    ...
    <div v-if="tableData.length">
      <el-button type="primary" @click="log" class="log">打印当前EXCEL文件</el-button>
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="name" label="采购姓名" width="180">
        </el-table-column>
        <el-table-column prop="stucode" label="采购号" width="180">
        </el-table-column>
  ...
  function load() {
    ...
    fromD.append(file.value.files[0]);
